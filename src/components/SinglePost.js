            ...
            <div className="w-100 text-center d-flex flex-column gap-1" onClick={openModal}>
                ...
                <div className="d-flex w-100 justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-3">
                        <div className="d-flex gap-2 align-items-center"><i className="fa-solid fa-thumbs-up"></i>{post.likes.length}</div>
                        <div className="d-flex gap-2 align-items-center"><i className="fa-solid fa-comment"></i>{post.comments.length}</div>
                    </div>
